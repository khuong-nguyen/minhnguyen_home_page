				...
				<div class="col-md-6 col-lg-3 ftco-animate">
					<div class="project">
						...
						<div class="text text-center">
							<h3><a href="project.html">Không chuyên không làm. Đem đến giải pháp tốt nhất</a></h3>
						</div>
...
<!-- 		</div> -->
<!-- 	</section> -->
	<!--section class="ftco-appointment ftco-section img" style="background-image: url(images/bg_1.jpg);"-->
<!-- 		<div class="overlay"></div> -->
<!-- 		<div class="container"> -->
<!-- 			<div class="row"> -->
...
<!-- 		<div class="container"> -->
			<!--div id="map" style="width: 500px; height: 500px; align-text: center;"></div-->
<!-- 		</div> -->
<!-- 	</section> -->
			...
			<div class="row mb-5">
				<div class="col-md">
					<div class="ftco-footer-widget mb-4">
						<h2 class="ftco-footer-logo">My friend <span>ITsolution</span></h2>
						<p>Dịch vụ công nghệ thông tin của My friend triễn khai luôn đem đến lợi ich hoặc ít nhất là không lỗ cho đối tác.</p>
...
<!-- 				<div class="col-md">
				...
				<div class="col-md">
					<div class="ftco-footer-widget mb-4">
						...
						<ul class="list-unstyled">
							<li><a href="#" class="py-2 d-block">Company Outline</a></li>
							<li><a href="#" class="py-2 d-block">Customer & Partner List</a></li>
				...
				<div class="col-md">
					<div class="ftco-footer-widget mb-4">
						...
						<div class="block-23 mb-3">
							<ul>
								<li><span class="icon fa fa-map marker"></span><span class="text">744/4 Trần Hưng Đạo P2, Q5 TP. HCM</span></li>
								<li><a href="#"><span class="icon fa fa-phone"></span><span class="text">+84 0908 838 987</span></a></li>
								<li><a href="#"><span class="icon fa fa-paper-plane pr-4"></span><span class="text">info@myfriend.com</span></a></li>
							</ul>
						</div>
					</div>
				</div>
			...
			<div class="row">
				<div class="col-md-12 text-center">
					...
					<p>
						Copyright (C) myfriend Co.,Ltd. Since 2020 All Rights Reserved</a>
					</p>
					</div>
				</div>
			</div>
